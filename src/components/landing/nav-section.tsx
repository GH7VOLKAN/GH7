...
export function NavSection() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-5 sm:px-10 h-[60px] flex items-center justify-between bg-white/85 backdrop-blur-[16px] border-b border-zinc-100">
      ...
      <div className="flex items-center gap-7">
        <a href="#geo" className="hidden sm:inline text-[13px] text-zinc-500 font-medium hover:text-[#09090B] no-underline transition-colors">
          GEO Nedir
        </a>
